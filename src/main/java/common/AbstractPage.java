...
public class AbstractPage {
    ...
    public static void sleepInMiliSecond(long millis) {
        try {
            Thread.sleep(millis);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void sendKeyToElementWithoutClear(WebDriver driver, String locator, String value) {
        getElement(driver, locator).sendKeys(value);
    }
    ...
    public void selectDropdownByOptionsValue(WebDriver driver, String locator, String value) {
        select = new Select(getElement(driver, locator));
    ...
    public void pressBackSpaceByRobot(WebDriver webDriver) {
        try {
        robot = new Robot();
        robot.keyPress(KeyEvent.VK_BACK_SPACE);
        robot.keyRelease(KeyEvent.VK_BACK_SPACE);
    ...
    public void mouseClickToElementByRobot(WebDriver webDriver) {
        try {
    ...
    public static void waitForPageToLoadCompletely(WebDriver driver, long timeOutInSeconds) {
