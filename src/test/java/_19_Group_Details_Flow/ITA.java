...
//        2        Click on Main Menu -> Setup ->  Groups
        ...
        sleepInSecond(10);
        takeSnapShot(driver, GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\01_Setup_Groups_Area.png");
...
//        4        Click on Group Details
        ...
        sleepInSecond(4);
        takeSnapShot(driver, GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\02_Groups_labudae_Details_Area.png");

//        5        Click on Business Leader field
        clickToElement(driver, "//a[@data-testid='businessLeader-add-button']");
        sleepInSecond(3);
        takeSnapShot(driver, GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\03_labudae_Details_Click_Business_Leader.png");

//        6        Click Save Changes
        clickToElement(driver, "//button[@data-testid='save-changes-button']");
        sleepInSecond(3);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='details-page-error-summary']", GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\04_labudae_Details_Save_Changes_Error_Message.png");
...
//        10        Click Save Changes
        clickToElement(driver, "//button[@data-testid='save-changes-button']");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "(//div[contains(@class,'layout-grid')])[1]", GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\05_labudae_Details_Save_Changes_Success.png");

//        11        Hover over Collapse All button
        hoverToElement(driver, "//button[@data-testid='collapse-button']");
        sleepInSecond(3);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='tooltip-styled']/div", GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\06_labudae_Details_Collapse_All_Tooltip.png");

//        12        Hover over Edit button
        hoverToElement(driver, "//button[@data-testid='edit-sections-trigger-button']");
        sleepInSecond(3);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='tooltip-styled']/div", GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\07_labudae_Details_Edit_Tooltip.png");

//        13        Click on Edit button
        clickToElement(driver, "//button[@data-testid='edit-sections-trigger-button']");
        sleepInSecond(4);
        takeSnapShotWithHighlight(driver, "(//ul[@id='dropdown-options'])[4]", GlobalConstants.GROUP_DETAILS_FLOW + "\\ITA\\08_labudae_Details_Edit_Dropdown.png");
