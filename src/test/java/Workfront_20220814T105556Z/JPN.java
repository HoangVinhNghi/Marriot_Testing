...
//        4. Click on three dots -> Edit
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='lightbox-section-customforms']//span[2]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\JPN\\001_UyA.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='FLOOR']", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\JPN\\06_YBh.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='CLEARTIME']", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\JPN\\09_YBS.png");

        dragAndDropHTML5ByJS(driver,"//li[@id='CLEARTIME']","//div[@data-testid='dropzone-canvas']");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div[1]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\JPN\\08_YBR.png");
    }
...
//         3. Click on Configure button
        ...
        takeSnapShotWithHighlight(driver, "//div[contains(@class,'module_positionRight__3lKJB')]/following-sibling::div//button[contains(@style,'hideButton')]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\JPN\\02_YA+.png");
        sleepInSecond(2);
