...
//         5. Click on 'X' to remove the file (SR string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ENU\\05_YBg.png");

        sleepInSecond(5);
        clickToElement(driver,"//*[local-name()='svg' and @data-testid='close-icon']");
        inspectElement(driver,"//div[@data-testid='document-info']");
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ENU\\04_YBe.png");
