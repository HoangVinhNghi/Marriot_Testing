...
//        4. Click on three dots -> Edit
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='lightbox-section-customforms']//span[2]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\001_UyA.png");
...
//        4. Mouse hover link numbe in the Predecessor field
        ...
        takeSnapShotWithHighlight(driver, "//a[@data-testid='see-project-link']/parent::div/preceding-sibling::div/div[2]/div", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\03_YBd.png");
    }
...
//         5. Click on 'X' to remove the file (SR string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\05_YBg.png");

        sleepInSecond(5);
        clickToElement(driver,"//*[local-name()='svg' and @data-testid='close-icon']");
        inspectElement(driver,"//div[@data-testid='document-info']");
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\04_YBe.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='FLOOR']", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\06_YBh.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='CLEARTIME']", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\09_YBS.png");

        dragAndDropHTML5ByJS(driver,"//li[@id='CLEARTIME']","//div[@data-testid='dropzone-canvas']");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div[1]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\08_YBR.png");
    }
...
//         3. Click on Configure button
        ...
        takeSnapShotWithHighlight(driver, "//div[contains(@class,'module_positionRight__3lKJB')]/following-sibling::div//button[contains(@style,'hideButton')]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\02_YA+.png");
        sleepInSecond(2);
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\07_YBm.png");
...
//        3. Select 'Project' radio button and RMB -> Inspect it (SR string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\10_YBT.png");
...
//        3. Select 'Project' radio button and RMB -> Inspect it (SR string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\11_YBU.png");
        sleepInSecond(1);
...
//        3. Select 'Project' radio button and RMB -> Inspect it (SR string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220814T105556Z\\ITA\\12_YBX.png");
