...
//        1. Login to Workfront 2. Go to Main Menu -> Goals 3. Click Create goal and confirm 4. Click on Progress Indicators
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@data-colindex='6']", GlobalConstants.WF_20220703T103435Z + "/FRA/01_X+i_X+Z.png");
...
//        1. Login to Workfront 2. Go to Main Menu -> Goals 3. Click Create goal and confirm 4. Mouse hover 'Progress' icon
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='tooltip-styled']", GlobalConstants.WF_20220703T103435Z + "/FRA/02_X+k.png");
...
//        1. Login to Workfront 2. Go to Home -> Edit delegation - Delegate tasks and issues 3. Enter any delegate name and click Save
        ...
        takeSnapShotWithHighlight(driver, "//button[@data-testid='go-to-work-delegations']", GlobalConstants.WF_20220703T103435Z + "/FRA/03_X+S.png");
...
//        5. Click on New(field) button 6. Drag&Drop YEAR function into the content panel
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div/div", GlobalConstants.WF_20220703T103435Z + "/FRA/04_X+M.png");
...
//        1. Login to Workfront 2. Go to Main Menu -> Reporting 3. Click New report 4. Drag&Drop Table block and click Edit 5. Click on New(field) button
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//li[@id='YEAR']", GlobalConstants.WF_20220703T103435Z + "/FRA/05_X+L.png");
    }
...
//        1. Login to Workfront 2. Go to Home -> Edit delegation - Delegate tasks and issues 3. Right click -> Inspect on any delegation dialogue (aria-label string)
        ...
        sleepInSecond(1);
        captureScreen(GlobalConstants.WF_20220703T103435Z + "/FRA/06_Xb3.png");
        sleepInSecond(1);
        closeChromeDevTool();
    }
...
//        3. Select 'share.make.editable.system.wide.sublabel' field and press 'Share' button 4. Click on cog icon
        ...
        takeSnapShotWithHighlight(driver, "//li[@data-value='editableSystemWide']//div[@class='sublabel']", GlobalConstants.WF_20220703T103435Z + "/FRA/07_R-w.png");
