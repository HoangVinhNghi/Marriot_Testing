...
//6. Click on a ''+ Add choice''
        ...
        //Take ss:
        takeSnapShotWithHighlight(driver,"(//div[contains(@class,'Menu-itemGrid')])[6]", GlobalConstants.SCREENSHOTS+folder+"005_YdU.png");
...
//7. Click on a ''New'' button on the ''My Issue'' widget
    ...
    //take SS
    waitForElementVisible(driver,"(//form[@data-form-type='search']//span)[1]");
    takeSnapShotWithHighlight(driver,"(//form[@data-form-type='search']//span)[1]", GlobalConstants.SCREENSHOTS+folder+"010_YdF.png");
