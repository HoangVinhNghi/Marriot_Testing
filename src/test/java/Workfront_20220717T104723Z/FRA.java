...
//        4. Enter any name and click Create
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='inactivity-lifetime-section']/span", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\01_X+0.png");
        takeSnapShotWithHighlight(driver, "//div[@data-testid='absolute-lifetime-section']/span", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\07_X+z.png");
        sleepInSecond(1);
...
//        6. Drag&Drop In function into the content panel
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div[3]/div", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\02_X+1.png");
    }
    @Test
...
//        6. Drag&Drop In function into the content panel
        ...
        dragAndDropHTML5ByJS(driver,"//li[@id='IN']","//div[@data-testid='dropzone-canvas']");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div[4]/div[2]/span", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\03_X+2.png");
    }
...
//        6. Drag&Drop In function into the content panel
        ...
        dragAndDropHTML5ByJS(driver,"//li[@id='IN']","//div[@data-testid='dropzone-canvas']");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div[2]/span", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\04_X+3.png");
    }
    @Test
...
//        5. Click on New(field) button
        ...
        sendKeyToElement(driver,"//input[@id='configuration-search-input']","IN");
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//li[@id='IN']/div/div/span[1]", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\05_X+4.png");
    }
    @Test
...
//        3. Click on Report Actions button
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='button-options']//li[@data-testid='option-6']", GlobalConstants.SCREENSHOTS + "\\Workfront_20220717T104723Z\\FRA\\06_X+5.png");
    }
