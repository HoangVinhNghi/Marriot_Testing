...
//        5. Click on 'New progress indicator' button
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@data-testid=\"dialog\"]//div[@data-testid=\"name-editor-element\"]", GlobalConstants.WF_20220905T112238Z + "\\FRA\\01_X9L.png");
...
//        4. Click on dropdown button
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//li[@data-testid='option-1']", GlobalConstants.WF_20220905T112238Z + "\\FRA\\02_YBL.png");
        clickToElement(driver,"//li[@data-testid='option-1']");
    }
