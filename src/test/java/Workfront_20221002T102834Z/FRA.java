...
//        6. Expand user list and mouse hover 'On the project' icon
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='tooltip-styled']//span", GlobalConstants.SCREENSHOTS + "\\Workfront_20221002T102834Z\\FRA\\01_YE0.png");
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='field-select-options']//li[@role='presentation']", GlobalConstants.SCREENSHOTS + "\\Workfront_20221002T102834Z\\FRA\\02_YE1.png");
    }
...
//         3. Go to Progress indicators tab
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-valuefield='actualProgress']", GlobalConstants.SCREENSHOTS + "\\Workfront_20221002T102834Z\\FRA\\03_YEa.png");

        if (driver.findElement(By.xpath("//div[contains(@id,'/progress-indicators')]/span")).isDisplayed()) {
            takeSnapShotWithHighlight(driver, "//div[contains(@id,'/progress-indicators')]", GlobalConstants.SCREENSHOTS + "\\Workfront_20221002T102834Z\\FRA\\04_YEZ.png");
        } else {
