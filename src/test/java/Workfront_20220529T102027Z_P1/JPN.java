...
//        4. Try removing groups where this user is an administrator
        ...
        takeSnapShotWithHighlight(driver,"//div[@class='ContextMessagePanel warning otherGroupsRemoveInfoPanel']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\001_VNb.png");
    }
...
//        3. Click New Project -> Existing Project
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='sliding-pane-header']/span",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\002_X1e.png");
...
//         3. Click New Project -> Existing Project
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//div[@data-testid='sliding-pane-header']/span",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\003_X1P.png");
...
//        4. In the first tab click on three dots near campaign name -> Delete
        ...
        takeSnapShotWithHighlight(driver,"//section[@data-testid='confirm-dialog-dialog-body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\004_X1t.png");
        clickToElement(driver,"//button[@data-testid='confirm-button-confirm-dialog']");
    }
...
//        4. In the first tab click on three dots near campaign name -> Delete
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//section[@data-testid='confirm-dialog-dialog-body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\005_X1x.png");
        clickToElement(driver,"//button[@data-testid='confirm-button-confirm-dialog']");
    }
...
//        3. Filter the logs in a way that no results appear
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell']/parent::div/following-sibling::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\006_X2-.png");
    }
...
//        4. Click on three dots near name -> Edit goal -> Save
        ...
        takeSnapShotWithHighlight(driver,"//span[@data-testid='body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\008_X23.png");
...
//        4. Click on three dots near name -> Copy Goal -> Copy goal
        ...
        waitForElementVisible(driver,"//div[@data-testid='toast-notification']");
        takeSnapShotWithHighlight(driver,"//span[@data-testid='body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\009_X24.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='RIGHT']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\010_X25.png");
    }
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='MONTH']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\011_X27.png");
    }
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver, "//li[@id='LEFT']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\012_X28.png");
    }
...
//        5. Click three dots -> Convert to task
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='field-destinationProject-label']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\014_X2a.png");
...
//        5. Click three dots -> Convert to task
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='lightbox-section-destinationProjectSection']/h2",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\015_X2d.png");
...
//        5. Click three dots -> Copy to...
        ...
        waitForElementVisible(driver,"//div[@data-testid='field-destinationProject-label']");
        takeSnapShotWithHighlight(driver, "//div[@data-testid='field-destinationProject-label']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\016_X2e.png");
...
//        4. Click on three dots near name -> Edit goal -> Save
        ...
        waitForElementVisible(driver,"//div[@data-testid='toast-notification']");
        takeSnapShotWithHighlight(driver,"//span[@data-testid='body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\017_X2w.png");
...
//        4. Click on three dots near name -> Copy Goal -> Copy goal
        ...
        waitForElementVisible(driver,"//div[@data-testid='toast-notification']");
        takeSnapShotWithHighlight(driver,"//span[@data-testid='body']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\018_X2x.png");
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//button[@data-name='action-type-filter-button']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\025_X38.png");
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='date-from']/div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\038_X3h.png");
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//button[@data-name='users-button']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\041_X3k.png");
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][5]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\048_X3o.png");
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][1]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\055_X3s.png");
    }
...
//        3. Click on 'Users' textfield
        ...
        takeSnapShotWithHighlight(driver,"//input[contains(@class,'ta-input typeAheadInput_')]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\066_X3z.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//button[@data-name='action-type-filter-button']/preceding-sibling::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\077_X48.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//button[@data-name='log-filter-button']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\097_X4K.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='setup-header-container']//h2",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\116_X4X.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][6]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\131_X5b.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][4]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\134_X5C.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][3]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\137_X5E.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"(//button[@data-name='apply-button'])[1]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\141_X5G.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='count-picker-container']/parent::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\142_X5h.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        waitForElementVisible(driver,"//div[@data-name='count-picker-container']/parent::div");
        takeSnapShotWithHighlight(driver,"//div[@data-name='count-picker-container']/parent::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\144_X5I.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//button[@data-name='users-button']/parent::span/preceding-sibling::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\146_X5J.png");
    }
...
//        2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='header-cell'][7]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\167_X5W.png");
    }
...
//         3. In the Action Type select exactly 1 action
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//button[@data-name='action-type-filter-button']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\173_X6-.png");
    }
...
//         2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='date-to']/div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\179_X64.png");
    }
...
//         2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//a[@data-name='clear-filters']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\196_X6i.png");
    }
...
//        3. In the Action Type select 2 or more actions
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//button[@data-name='action-type-filter-button']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\207_X6o.png");
    }
...
//         2. Go to Setup -> System -> Audit Logs
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-name='count-picker-container']/parent::div/following-sibling::div[1]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\218_X6V.png");
    }
...
//         2. Go to Home page and click Delegate
        ...
        takeSnapShotWithHighlight(driver,"//label[@id='startDate-label']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\230_X7e.png");
    }
...
//         2. Go to Main Menu -> Campaigns
        ...
        takeSnapShotWithHighlight(driver,"//button[contains(@class,'spectrum-ActionButton_')]",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\231_X7f.png");
    }
...
//        5. Refresh details page of a created goal and mouse hover tooltip icon
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='tooltip-styled']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\235_X23.png");
...
//        6. Drag&Drop CONCAT function into content panel 7. Right click -> Inspect on a 'drop a field or enter text' panel (aria-label string)
        ...
        sleepInSecond(2);
        captureScreen(GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\233_X7G.png");
...
//        4. On the Goals page expand created goal and add some dummy result to it. 5. Refresh details page of a created goal and click on 'Copy results' checkbox
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='alert-icon-container']/following-sibling::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\237_X7I.png");
    }
...
//        5. Click on New(field) button 6. Drag&Drop MONTH function into content panel
        ...
        sleepInSecond(2);
        takeSnapShotWithHighlight(driver, "//div[@data-testid='node-argument-drop-zone']", GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\256_X7j.png");
        takeSnapShotWithHighlight(driver, "//div[@type='formula']/div[2]/div/div/div", GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\255_X7j.png");
    }
...
//        4. Click on three dots near name -> Copy Goal 5. Mouse hover tooltip icon
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='tooltip-styled']",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\239_X7J.png");
...
//        5. Right click -> Inspect on 'Include if all are true' dropdown (aria-label string)
        ...
        captureScreen(GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\257_X7k.png");
    }
...
//        3. Click Create goal and confirm 4. Click on three dots near name -> Copy Goal
        ...
        takeSnapShotWithHighlight(driver,"//span[@data-testid='info-icon']/preceding-sibling::span",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\241_X7K.png");
    }
    @Test
...
//        1. Login to Workfront 2. Go to Main Menu -> Goals 3. Click Create goal and confirm 4. Click on three dots near name -> Edit
        ...
        takeSnapShotWithHighlight(driver,"//h1[@data-testid='dialog-dialog-header-text']//div[@data-testid='name-editor-element']/div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\258_X7m.png");
...
//        4. On the Goals page expand created goal and add some dummy result to it. 5. Refresh details page of a created goal and mouse hover tooltip icon
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='tooltip-styled']",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\243_X7M.png");
...
//        4. Click on three dots near name -> Copy Goal 5. Mouse hover tooltip icon
        ...
        takeSnapShotWithHighlight(driver,"//div[@data-testid='tooltip-styled']",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\244_X7N.png");
...
//       3. Click Create goal and confirm 4. Click on three dots near name -> Copy Goal
        ...
        takeSnapShotWithHighlight(driver,"//span[@data-testid='info-icon']/preceding-sibling::span",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\245_X7O.png");
    }
...
//       4. On the Goals page expand created goal and add some dummy result to it. 5. Refresh details page of a created goal and click on 'Copy results' checkbox
        ...
        takeSnapShotWithHighlight(driver, "//div[@data-testid='alert-icon-container']/following-sibling::div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\246_X7P.png");
    }
...
//       3. Click Create goal and confirm 4. Click on three dots near name -> Edit
        ...
        takeSnapShotWithHighlight(driver, "//h1//div[@data-testid='name-editor-element']/div",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\247_X7Q.png");
    }
...
//       3. Click Create goal and confirm 4. Click on three dots near name -> Copy Goal
        ...
        takeSnapShotWithHighlight(driver,"//header//div[@data-testid='name-editor-wrapper']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\248_X7R.png");
    }
...
//        Direct link: https://adobeloctesting.devtest.workfront-dev.com/home/worklist 1. Login to Workfront 2. Go to Home page and click Delegate
        ...
        takeSnapShotWithHighlight(driver,"//label[@id='endDate-label']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\253_X7W.png");
...
//        3. Create some campaigns 4. Select two and click Delete
        ...
        takeSnapShotWithHighlight(driver,"//h1[@id='confirm-dialog-dialog-header-text']",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\249_X7S.png");
        takeSnapShotWithHighlight(driver,"//section",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\250_X7T.png");
        takeSnapShotWithHighlight(driver,"//h1[@id='confirm-dialog-dialog-header-text']",GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\255_X7Y.png");
...
//        1. Login to Workfront 2. Go to Projects -> New Project 3. Switch to Issues tab and add any issue 4. Select created Issue 5. Click three dots -> Convert to task
        ...
        takeSnapShotWithHighlight(driver,"//h2[@data-testid='lightbox-text-section-destinationProjectSection']",
                GlobalConstants.SCREENSHOTS+"\\Workfront_20220529T102027Z\\JPN\\3080185\\JPN\\258_Xuf.png");
