...
public class JPN extends AbstractPage {
    WebDriver driver;
    String folder = "\\Workfront_20221021T194141Z\\JPN\\3500827\\JPN\\"; // the path to store the captured images with  lang code can be changed accordingly
...
//        1. Login to Workfront 2. Go to Templates and select any template 3. Click Edit in the toolbar and scroll down 4. Mouse hover info icon near "Milestone Path" option
        ...
        //Select any template
        waitForElementVisible(driver,"(//a[@data-test-id='LinkSimple'])[1]");
...
//        10. Click on any Upload File icon in the table 11. Upload any txt file 12. Right click -> Inspect on a file icon (aria-label string)
        ...
        robot1.keyPress(KeyEvent.VK_F12);  robot1.keyRelease(KeyEvent.VK_F12);
        sleepInSecond(1);
...
//        1. Login to Workfront 2. Go to Boards and create a new board 3. In the configure panel expand Column section
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//input[@data-testid='card-count-switch']/parent::label/parent::div/h5", GlobalConstants.SCREENSHOTS+folder+"014_YIc.png");
    }
...
//        1. Login to Workfront 2. Go to Timesheets and open any admin timesheet 3. In new tab go to Setup -> Login As and login as any user 4. Refresh the timesheet tab
        ...
        takeSnapShotWithHighlight(driver,"//h2[@data-testid='error-message']", GlobalConstants.SCREENSHOTS+folder+"018_YIm.png");
...
//        1. Login to Workfront 2. Go to Blueprints 3. Click on Install button of a "Add/Delete/Edit Employee IT Setup Project Details" blueprint
        ...
        waitForPageToLoadCompletely(driver,60);
        clickToElement(driver,"(//div[@class='pb-6']/button)[1]");
...
//        clickToElement(driver,"//div[contains(@class,'border-bottom')]/div[contains(@class,'flex gap')]/button"); //Click on Manage widgets
        ...
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//div[@id='react-spectrum-6-title']",
                GlobalConstants.SCREENSHOTS+folder+"022_YM2.png");

        // YM0	Updates I've Been Mentioned In
        scrollToElement(driver,"//div[@id='react-spectrum-6-title']");
        sleepInSecond(1);
        takeSnapShotWithHighlight(driver,"//div[@id='react-spectrum-6-subtitle']",
...
//      5. You should now see a floating icon that when clicked will open the Workfront Inspector 6. Enable feature toggles: home-workspaces 7. Open home page
        ...
        waitForElementVisible(driver,"//button[@id='home-new-task-button']");
...
//      MockID: YNG	The timesheet is awaiting approval. You must recall the timesheet to add time.	None
//      Test Environment: https://adobeloctesting.devtest.workfront-dev.com/login?nextURL=%2Fhome
//      Test User: adobeloctesting@workfront.com / 2wsx#EDC Direct link: https://adobeloctesting.devtest.workfront-dev.com/timesheet/637ce0a0000229fd4cfc5aa8b280747e/overview
//      1. Login to Workfront 2. Go to timesheets and create a new one with Admin user as target and approver 3. Make some change and send it for approval 4. Mouse hover any previously editable cell
    ...
    @Test
    public void String_044() throws AWTException, InterruptedException {
//      MockID: YNH	The timesheet is closed. You must reopen the timesheet to add time.
//      Test Environment: https://adobeloctesting.devtest.workfront-dev.com/login?nextURL=%2Fhome
//      Test User: adobeloctesting@workfront.com / 2wsx#EDC Direct link: https://adobeloctesting.devtest.workfront-dev.com/timesheet/637ce0a0000229fd4cfc5aa8b280747e/overview
//      1. Login to Workfront 2. Go to timesheets and create a new one with Admin user as target and approver 3. Make some change and send it for approval
//      4. Click Approve 5. Mouse hover any previously editable cell

        openPageUrl(driver, "https://adobeloctesting.devtest.workfront-dev.com/timesheet/637341100000ca83fd26f33d6eeba3df/overview");
        waitForElementVisible(driver, "//input[@aria-rowindex='4' and @aria-colindex='6']");
        sleepInSecond(1);
        hoverToElement(driver, "//input[@aria-rowindex='4' and @aria-colindex='6']");

        // YNG	The timesheet is awaiting approval. You must recall the timesheet to add time.
        takeSnapShotWithHighlight(driver, "//div[@data-testid='tooltip-styled']", GlobalConstants.SCREENSHOTS + folder + "044_YNH.png");
