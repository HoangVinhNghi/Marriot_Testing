...
public class ENU extends AbstractPage {
    WebDriver driver;
    String folder = "\\Workfront_20230108T104644Z\\ENU\\"; // the path to store the captured images with  lang code can be changed accordingly
...
//        1. Login to Workfront 2. Open any project 3. Go to Tasks and open any task 4. Go to Subtask and create some subtasks 5. Select any subtask and start spamming any intent button(in the toolbar)
        ...
        clickToElement(driver,"//button[@data-testid='add-widget-button']");

        // Take SS: YXK	Awaiting my approval
        takeSnapShotWithHighlight(driver,"//*[name()='path' and contains(@d,'M15.5 10a5.5 5.5 0')]/ancestor::div[@class='spectrum-Card-coverPhoto']/following-sibling::div//div[@class='spectrum-Card-title']",
                GlobalConstants.SCREENSHOTS+folder+"002_YXK.png");

        // Take SS: YXJ	Items that need my approval
        takeSnapShotWithHighlight(driver,"//*[name()='path' and contains(@d,'M15.5 10a5.5 5.5 0')]/ancestor::div[@class='spectrum-Card-coverPhoto']/following-sibling::div//div[@class='spectrum-Card-content']",
