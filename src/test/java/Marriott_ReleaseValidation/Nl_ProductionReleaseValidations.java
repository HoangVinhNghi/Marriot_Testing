...
public class Nl_ProductionReleaseValidations extends AbstractPage {
    WebDriver driver;
...
// 1. We move to the next cluster, 13b, the url would be https://www.marriott.com/nl/default.mi?AKAQA=qa13b
        driver.get("https://www.marriott.com/nl/default.mi?AKAQA=qa9b");
        waitForPageToLoadCompletely(driver, 30);
...
// 7. We have successfully modified our booking. This concludes validations on 13b. Any functionality defects on the pages tested should be reported.
    ...
    @Test
    public void Validate_9b() throws Exception {
//        Account 2
//        First name: Jonckerstwo
//        Last name: Test Mar QA
//        Email – Jonckerstesting2@gmail.com
...
// 1. Validations of 9b: We follow steps 1 to 3 from cluster 13b. https://www.marriott.com/nl/default.mi?AKAQA=qa9b
