...
public class Vi_ProductionReleaseValidations extends AbstractPage {
    WebDriver driver;
...
//        driver.get("https://www.marriott.com/vi/default.mi?AKAQA=qa16b");
...
// 1. We validate 16b first*: We launch https://www.marriott.com/vi/default.mi?AKAQA=qa16b. This link will bring us to the 16b inactive cluster.**
        driver.get("https://www.marriott.com/vi/default.mi?AKAQA=qa16g");
...
// 4. We proceed with our reservation and ReviewReservationDetails.mi will display already the details saved on the account we logged in to.
        ...
        clickToElement(driver,"(//a[@class='js-view-rate-btn-link analytics-click '])[1]"); //Choose hotel
        clickToElement(driver,"(//div[contains(@class,' l-rate-button rate-button')]/button)[1]"); //Choose room
...
// for a FLEXIBLE RATE,
        ...
        clickToElement(driver,"//a[@data-component-name='signOutLink']");
...
// 1. We move to the next cluster, 13b, the url would be https://www.marriott.com/vi/default.mi?AKAQA=qa13b
        driver.get("https://www.marriott.com/vi/default.mi?AKAQA=qa13g");
        waitForPageToLoadCompletely(driver, 30);
...
// 1. We move to the next cluster, 13b, the url would be https://www.marriott.com/vi/default.mi?AKAQA=qa13b
        driver.get("https://www.marriott.com/vi/default.mi?AKAQA=qa8g");
        waitForPageToLoadCompletely(driver, 30);
...
// 1. Validations of 9b: We follow steps 1 to 3 from cluster 13b. https://www.marriott.com/vi/default.mi?AKAQA=qa9b
        driver.get("https://www.marriott.com/vi/default.mi?AKAQA=qa9b");
        waitForPageToLoadCompletely(driver, 30);
