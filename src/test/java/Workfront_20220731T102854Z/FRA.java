...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver,
                "//li[@id='NUMBER']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\002_YAa.png");
        ...
        takeSnapShotWithHighlight(driver,
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\025_YAZ.png");
...
//        5. Click on New(field) button
        ...
        takeSnapShotWithHighlight(driver,
                "//li[@id='STRING']",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\023_YAX.png");
        ...
        takeSnapShotWithHighlight(driver,
                "//div[@type='formula']/div[2]/div/div[1]",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\003_YAb.png");

        // Capture screenshots for string 024. YAY - drop a field here
        takeSnapShotWithHighlight(driver,
                "//div[@data-testid='node-argument-drop-zone']//span",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\024_YAY.png");
...
//        3. Click on 'Show only users on this project'
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\004_YAe.png");
...
//        3. Mouse hover 'Show only users on this project'
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\006_YAi.png");
        ...
        takeSnapShotWithHighlight(
                driver, "//div[@data-testid='tooltip-styled']//span",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\005_YAg.png");
...
//        3. Mouse hover predecessor icon(switch to Standart view to see this field)
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\007_YAj.png");
        ...
        takeSnapShotWithHighlight(
                driver, "(//button[contains(@data-testid,'-accordion_button')]//span)[1]",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\009_YAk.png");
    }
...
//        4. Select all tasks and click 'add'
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\010_YAL.png");

        //capture screen for string 16. YAR - Add {0} {__mlm_low_tasks}
        takeSnapShotWithHighlight(
                driver, "//section[@data-testid='add-objects-confirmation-dialog-body']//h2",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\016_YAR.png");
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\021_YAU.png");
...
//        3. Click on Groups button
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\011_YAn.png");

        // Capture screenshots for string 15. YAr - None
        takeSnapShotWithHighlight(
                driver, "//input[@data-testid='group-by-NONE']/parent::label",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\015_YAr.png");
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\014_YAq.png");
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\012_YAo.png");
        ...
        takeSnapShotWithHighlight(
                driver, "(//span[contains(@class,'spectrum-FieldLabel_')])[2]/following-sibling::div/label[1]",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\019_YAt.png");

        //Capture screenshots for string 17. YAs - Override assignees
        takeSnapShotWithHighlight(
                driver, "(//span[contains(@class,'spectrum-FieldLabel_')])[2]/following-sibling::div/label[2]",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\017_YAs.png");
...
//        4. Select all Issues and click 'add'
        ...
        takeSnapShotWithHighlight(
                driver, "//section[@data-testid='add-objects-confirmation-dialog-body']//h2",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\020_YAT.png");
        ...
        takeSnapShotWithHighlight(
                driver, "//section[@data-testid='add-objects-confirmation-dialog-body']//div",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\018_YAS.png");
...
//        4. Select all Issues and click 'add'
        ...
        takeSnapShotWithHighlight(
                driver, "//section[@data-testid='add-objects-confirmation-dialog-body']//h2",
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\022_YAV.png");
...
//        4. Click on All tab
        ...
        takeSnapShotWithHighlight(
                ...
                GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\001_Xpq.png");
        ...
        captureScreen(GlobalConstants.SCREENSHOTS + "\\Workfront_20220731T102854Z\\FRA\\008_YAJ.png");
